package net.kidshideaway.app.udemy.gamecodeschool.spaceinvaders;
...
public class SpaceInvadersActivity extends Activity {
    ...
    net.kidshideaway.app.udemy.gamecodeschool.spaceinvaders.SpaceInvadersEngine spaceInvadersEngine;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spaceInvadersEngine = new net.kidshideaway.app.udemy.gamecodeschool.spaceinvaders.SpaceInvadersEngine(this, size.x, size.y);
